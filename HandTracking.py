__authors__ = ["Joshua Gisi", "Brianna Faul", "Tyler Bean", "Williams Kenneth"]
__copyright__ = ""
...
class power_perceive:

    def __init__(self):
        self.frameWidth = 1600
...
if __name__ == '__main__':
    app = power_perceive() # init method instantiates run
