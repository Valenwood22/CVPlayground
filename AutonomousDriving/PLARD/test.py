...
def test(args):
    ...
    for i, (image, tr_image, lidar, tr_lidar) in enumerate(testloader):
        ...
        cv2.imshow('Test View', output_fg)
        cv2.waitKey(0)
        cv2.imwrite('N:/_Programming/CVPlayground/AutonomousDriving/PLARD/outputs/results/' + im_name_splits[0] + '_road_' + im_name_splits[1] + '.png', output_fg)
